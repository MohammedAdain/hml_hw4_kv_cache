...
- **Q7 (10 pt):** Submit your prefill attention implementation. Benchmark regular attention for `seq_len=[256,512,1024,2048,4096,8192,12288,16384]` and `batch=[1,4,8,16,32]`. Skip OOM cases. Plot throughput vs. intensity (color per batch). Explain.
